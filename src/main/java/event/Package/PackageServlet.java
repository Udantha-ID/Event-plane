...
public class PackageServlet extends HttpServlet {
    ...
    private void insertPackage(HttpServletRequest request, HttpServletResponse response)
        ...
        String serviceLevel = request.getParameter("serviceLevel");  // Changed to serviceLevel
        String eventType = request.getParameter("eventType");        // Changed to eventType

        Package newPackage = new Package(pkgName, description, price, duration, serviceLevel, eventType);
    ...
    private void updatePackage(HttpServletRequest request, HttpServletResponse response)
        ...
        Package updatedPackage = new Package(id, pkgName, description, price, duration, serviceLevel, eventType);
